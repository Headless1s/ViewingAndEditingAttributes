...
Процедура ДобавитьЭлементУсловногоОформления(Форма,
		ПутиЭлементовОтбора,
		Сравнение,
		Значение,
		ПутиПолейКомпоновки,
		ИмяПараметра,
		ЗначениеПараметра) Экспорт
	...
	Если ТипЗнч(ПутиЭлементовОтбора) = Тип("ТаблицаЗначений") Тогда
		...
		Для каждого СтрокаПути Из ПутиЭлементовОтбора Цикл
			ДобавитьЭлементОтбораУсловногоОформления(ГруппаОтбора.Элементы,
				СтрокаПути.Путь,
				СтрокаПути.Сравнение,
				СтрокаПути.Значение);
		КонецЦикла;
	Иначе
...
Функция ТаблицаЭлементовОтбора() Экспорт
